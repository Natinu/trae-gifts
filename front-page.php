...
<!-- Header -->
<div class="header header-desktop col-md-12">
	<?php $image = get_field('imagen-header'); ?>
	<img class="header__image header__image--home" src="<?php echo $image['url']; ?>" 
	alt="<?php echo $image['alt']; ?>" />
</div>
<div class="header-mobile col-md-12">
	<?php $image = get_field('header-mobile'); ?>
	<img class="header__image header__image--home" src="<?php echo $image['url']; ?>" 
	alt="<?php echo $image['alt']; ?>" />
</div>
</div>

<div class="products__grid--category-home">
	...
	<div class="col-md-12">
		...
		<ul class="products__grid--list">
			...
			while($destacados->have_posts()): $destacados->the_post(); ?>
				<div class="col-xs-6  col-md-15 col-lg-15 products__grid--item ">
...
<div class="bloghome container-fluid">
	...
	<div class="row">
		<div class="bloghome__name--container col-md-12">
			
			<div class="bloghome__name--lista container-fluid">
				<!-- Bloghome List -->
				<ul>
					<!-- Blog Item 1 -->
